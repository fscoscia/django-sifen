...
class IVAItem(SifenObject):
    ...
    # E722 - Descripción de la tasa de IVA (opcional)
...
class Item(SifenObject):
    ...
    # E615 - Descripción de relevancia (opcional)
