...
class SubtotalIVA(SifenObject):
    ...
    # F010 - Descripción de la tasa de IVA
...
class Totales(SifenObject):
    ...
    # F010 - Liquidación total de IVA 5%
    dLiqTotIVA5: Optional[Decimal] = None
    
    # F011 - Liquidación total de IVA 10%
    dLiqTotIVA10: Optional[Decimal] = None
    
    # F012 - Total de IVA de la operación
