...
TIPO_FACTURA_ELECTRONICA_EXPORTACION = 4
TIPO_FACTURA_ELECTRONICA_IMPORTACION = 5
TIPO_AUTOFACTURA_ELECTRONICA = 6
TIPO_NOTA_CREDITO_ELECTRONICA = 7
TIPO_NOTA_DEBITO_ELECTRONICA = 8
TIPO_NOTA_REMISION_ELECTRONICA = 9
TIPO_COMPROBANTE_RETENCION_ELECTRONICO = 10
